...
_main_factorial@o2:
		...
		mov ebp, esp
		sub esp, 4*2
		; Instanciamos un objeto de clase C
		push 28
		call malloc
		add esp, 4
		push eax
...
mov dword [__esp], esp
	call _create_ms_table
		...
		; Guarda el operando c1 en la pila
		push dword _c1
		; Liberamos la posicion de memoria de arriba de la pila
		pop eax
		push dword [eax]
		call free
		add esp, 4
		...
		; Instanciamos un objeto de clase D
		push 36
		call malloc
		add esp, 4
		push eax
		...
		; Instanciamos un objeto de clase B
		push 20
		call malloc
		add esp, 4
		push eax
